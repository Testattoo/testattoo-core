...
class ComponentFactoryTest {
    ...
    void should_have_generic_components_factory() {
        ...
        when(provider.metaInfo("\$('TextFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('SearchFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('EmailFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('URLFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('NumberFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('RangeFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('DateFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('ColorFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('DateTimeFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('MonthFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('PhoneFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('TimeFieldStub')")).thenReturn([metaInfo])
        ...
        when(provider.metaInfo("\$('WeekFieldStub')")).thenReturn([metaInfo])
    ...
    void should_throw_an_error_when_component_not_found() {
        ...
        try {
            ...
            assert e.message == "Unable to find class org.testattoo.core.component.field.EmailField with label or placeholder equals to 'Email Field Invalid Label'"
        }
    }
}
