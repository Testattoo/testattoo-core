...
//    @BeforeEach
//    void before() {
//        provider = Mockito.mock(Provider)
...
//        when(provider.metaInfo("\$('expression')")).thenReturn([new MetaInfo(id: '1', node: 'node')])
//
...
//        when(provider.metaInfo("\$('expression')"))
//            .thenReturn([new MetaInfo(id: '1', node: 'node'),
...
//
//        when(config.provider.metaInfo("\$('expression')")).thenReturn([new MetaInfo(id: '1', node: 'node')])
//        when(config.provider.check('1', "it.is('custom_1')")).thenReturn(false)
//        when(config.provider.check('1', identifyingExpression(CustomElement_2))).thenReturn(true)
//
//        try {
...
//        when(config.provider.metaInfo("\$('button')")).thenReturn([new MetaInfo(id: '2', node: 'BigButton')])
//        when(config.provider.check('2', identifyingExpression(BigButton))).thenReturn(true)
//
...
//        when(config.provider.metaInfo("\$('.btn')"))
//            .thenReturn([new MetaInfo(id: '1', node: 'node'),
//                         new MetaInfo(id: '2', node: 'node'),
//                         new MetaInfo(id: '3', node: 'node')])
//
